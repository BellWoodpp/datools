...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: buildCanonicalPath(undefined, "membership"),
  },
};

export default async function MembershipRootPage() {
  ...
  return (
    <div className="min-h-screen bg-neutral-50 dark:bg-neutral-950">
      <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
          ...
          <CardContent>
            <div className="flex items-center justify-between">
              ...
              <Badge variant={membershipStatus.plan === "free" ? "secondary" : "default"}>
                {membershipStatus.plan === "free"
                  ? dictionary.pages.membership.currentPlan.freeVersion
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-lg border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900">
                ...
                <p className="mt-1 text-2xl font-bold text-neutral-900 dark:text-neutral-100">
                  {membershipStatus.features.maxProjects === -1
                    ? "∞"
                    : membershipStatus.features.maxProjects}
                </p>
                <p className="text-xs text-neutral-500 dark:text-neutral-400">
              ...
              <div className="rounded-lg border border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-900">
                ...
                <p className="mt-1 text-2xl font-bold text-neutral-900 dark:text-neutral-100">
                  {membershipStatus.features.prioritySupport
                    ? dictionary.pages.membership.usage.priority
                ...
                {plan.current && (
                  <div className="absolute -top-3 left-1/2 transform -translate-x-1/2">
                    <Badge className="bg-blue-600 text-white">
                      {dictionary.pages.membership.upgradePlan.currentPlan}
                    </Badge>
                  </div>
                )}
                <CardHeader>
                ...
                <CardContent>
                  ...
                  >
                    {plan.current
                      ? dictionary.pages.membership.upgradePlan.currentPlan
                      : plan.price === 0
                        ? dictionary.pages.membership.upgradePlan.freeUse
                        : dictionary.pages.membership.upgradePlan.upgradePlan}
                  </Button>
                </CardContent>
              </Card>
            ))}
        ...
        {/* 账单历史 */}
        <BillingHistory dict={dictionary.pages.membership.billingHistory} locale={defaultLocale} />
      </div>
    </div>
  );
}
