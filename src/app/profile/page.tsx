...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: buildCanonicalPath(undefined, "profile"),
  },
};
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <p className="text-sm font-medium text-neutral-900 dark:text-neutral-100">
                {user.createdAt ? new Date(user.createdAt).toLocaleDateString(defaultLocale === 'zh' ? 'zh-CN' : defaultLocale === 'ja' ? 'ja-JP' : 'en-US') : dictionary.pages.profile.basicInfo.unknown}
              </p>
            </CardContent>
          </Card>
